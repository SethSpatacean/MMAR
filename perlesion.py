# -*- coding: utf-8 -*-
"""
Created on Thu May 20 13:25:21 2021
...
def mk_df_agg(df_module, df:'pd.DataFrame', agg_func, col_include=[]):
    
    col_include.append('confirm_idc')
    pd_agg_tmplt = 'pd_mmar_{FUNC}{PTYPE}'
    
    mmar_hrp = getattr(df_module, pd_agg_tmplt.format(FUNC=agg_func, PTYPE='_hrp'))[['confirm_idc', 'mmar_all_hrp', 'mmar_agg_type']].rename(columns={'mmar_all_hrp' : 'mmar'})
